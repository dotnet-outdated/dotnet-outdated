...
public class JsonFormatterTests
{
    ...
    public async Task JsonFormatterReportOutput()
    {
        ...
        [
          new AnalyzedProject("TweetiePie", @"C:\Coding\codeflow\tweetiepie\src\TweetiePie\TweetiePie.csproj",
          [
            new AnalyzedTargetFramework(NuGetFramework.Parse("net9.0"),
            [
              new AnalyzedDependency(
                new Dependency("Microsoft.Extensions.Http.Diagnostics", new VersionRange(previewVersion),
                  previewVersion, false, false, false, true), newerPreviewVersion),

              new AnalyzedDependency(
                new Dependency("Microsoft.Extensions.Http.Resilience", new VersionRange(previewVersion),
                  previewVersion,
                  false, false, false, true), newerPreviewVersion),

              new AnalyzedDependency(
                new Dependency("Microsoft.Extensions.Telemetry", new VersionRange(previewVersion), previewVersion,
                  false, false, false, true), newerPreviewVersion)
            ])
          ])
        ];
