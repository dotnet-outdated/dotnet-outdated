...
namespace DotNetOutdated
{
        ...
        ICentralPackageVersionManagementService centralPackageVersionManagementService) : CommandBase
    {
        ...
        [Option(CommandOptionType.SingleValue, Description = "Specifies an optional timeout in second to wait for \"dotnet msbuild restore\" to complete. If you have a very large project, you need to adjust this appropriately",
           ShortName = "tm", LongName = "timeout")]
        ...
        public async Task<int> OnExecute(CommandLineApplication app, IConsole console)
        {
            ...
            try
            {
                ...
                {
                    projectLists.Add(await _projectAnalysisService.AnalyzeProjectAsync(path, false, Transitive, TransitiveDepth, Runtime, TimeOut * 1000));
                });
