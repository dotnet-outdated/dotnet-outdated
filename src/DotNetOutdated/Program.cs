...
namespace DotNetOutdated
{
    ...
    internal class Program : CommandBase
    {
        ...
        private readonly INuGetPackageInfoService _nugetInfoService;
        ...
        [Option(CommandOptionType.MultipleValue, Description = "Specifies a nuget.config file to use. " +
                                                                "Can specify multiple files.",
            ShortName = "N", LongName = "nuget-file")]
        public List<string> NuGetFile { get; set; } = new List<string>();
        ...
        public Program(IFileSystem fileSystem, IReporter reporter, INuGetPackageResolutionService nugetService, IProjectAnalysisService projectAnalysisService,
            IProjectDiscoveryService projectDiscoveryService, IDotNetPackageService dotNetPackageService, ICentralPackageVersionManagementService centralPackageVersionManagementService, INuGetPackageInfoService nugetInfoService)
        {
            _fileSystem = fileSystem;
            _reporter = reporter;
            _nugetService = nugetService;
            _nugetInfoService = nugetInfoService;
        ...
        public async Task<int> OnExecute(CommandLineApplication app, IConsole console)
        {
            ...
            try
            {
                ...
                _nugetInfoService.LoadSettings(Path, NuGetFile);
